      ...
      <div style={styles.container2}>
        ...
        >
          ...
          >
            ...
            đảng chính trị tồn tại và phát triển theo những quan điểm của V.I
            Lênin về đảng kiểu mới của giai cấp vô sản.
          </div>
          <div style={{ ...styles.contentStyle, fontWeight: "bold" }}>
            Thế nào là đảng kiểu mới?
          </div>
          <div style={styles.contentStyle}>
            Lênin cho rằng, một đảng kiểu mới, là đảng phải lấy Chủ nghĩa Mác là
